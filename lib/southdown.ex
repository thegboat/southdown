defmodule Southdown do
  ...
  defdelegate flush_all, to: Basic
  defdelegate flush_db, to: Basic
  ...
  defdelegate async_flush_all, to: Async, as: :flush_all
  defdelegate async_flush_db, to: Async, as: :flush_db
  ...
  defdelegate async_incr(key), to: Basic, as: :incr
  defdelegate async_incrby(key, by), to: Async, as: :incrby
  defdelegate async_lpop(key), to: Async, as: :lpop
  ...
  defdelegate async_rpop(key), to: Async, as: :rpop
